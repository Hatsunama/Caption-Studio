...
final class TranslationOutputQuality {
  ...
  private static final Pattern SIMPLIFIED_ONLY = Pattern.compile("[们经这个来时会说为国学见点还对让从开关过实体线话头发无应长门车书买卖网电脑机与万专业东两乐习乱于云亲优传伤伦余儿党兰兴养内写军农冲况冻删则刚创划剧刘动务胜劳势区医华协单卫厂厅压县参双变叶号叹吗启员问园图圆圣场坏块坚报声处备复够梦夺奋妇妈孙宁宝将层岭岛屿帅师帐帧币库废广归录汇弹强当径彻忆怀态总恋战户扫扬换据损摇摄担拟扩摆择击数断旧暂术朴权条极样标楼档检欧欢岁杀壳毁气汉汤沟灭湾湿准滚满渔洁潜览灯炉争爱爷墙独获现环产画异疯疗监尽盘码礼种稳窝竞笔筑简签粮纠纪约红级细终组结绝统绿维紧编缓练缩绩继续罢罗职联听肃脑脚脱脸舰艺节范荐药虚虫补装规视觉订计讯记讨训托设许论证评词译议读丰猫贝负财责账货质购赶趋踪软转轮辑输办辞边遥邮乡释钟铁闪间队阳阴阵阶际陆险随杂鸡离难灵静页顶项顺顿领频题颜风飞饭馆马驾验鱼鸟黄齐龙]");
