...
1. Open the [latest Caption Studio release](https://github.com/Hatsunama/Caption-Studio/releases/tag/v1.4.47) on the phone.
...
curl -L -o ~/storage/downloads/caption-studio-android.apk \
  https://github.com/Hatsunama/Caption-Studio/releases/download/v1.4.47/caption-studio-android.apk
...
Current Android build: **1.4.47** (`v1.4.47`, Android version code 59).

Version 1.4.47 gives the caption script a real top editing anchor with leading and trailing scroll travel, so the first and final actual cues remain reachable without substituting a neighboring cue. While typing, the preview crops around the authored caption position instead of shrinking the complete video; the crop follows caption selection and position smoothly across portrait, landscape, and square canvases.
...
The installer requires release 1.4.47 or newer and refuses older APKs while the release is building. Both download routes use Hatsunama/Caption-Studio. See [audit coverage](docs/audit-1.4.8.md).
