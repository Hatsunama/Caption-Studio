...
1. Open the [latest Caption Studio release](https://github.com/Hatsunama/Caption-Studio/releases/tag/v1.4.45) on the phone.
...
curl -L -o ~/storage/downloads/caption-studio-android.apk \
  https://github.com/Hatsunama/Caption-Studio/releases/download/v1.4.45/caption-studio-android.apk
...
Current Android build: **1.4.45** (`v1.4.45`, Android version code 57).

Version 1.4.45 repairs caption-script preview synchronization and keyboard layout. A user scroll now updates both the selected preview caption and timeline time without playback stealing the gesture. While typing, the editor uses the actual resized workspace: video controls remain above the keyboard and the focused caption input stays visible.
...
The installer requires release 1.4.45 or newer and refuses older APKs while the release is building. Both download routes use Hatsunama/Caption-Studio. See [audit coverage](docs/audit-1.4.8.md).
