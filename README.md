...
1. Open the [latest Caption Studio release](https://github.com/Hatsunama/Caption-Studio/releases/tag/v1.4.44) on the phone.
...
curl -L -o ~/storage/downloads/caption-studio-android.apk \
  https://github.com/Hatsunama/Caption-Studio/releases/download/v1.4.44/caption-studio-android.apk
...
Current Android build: **1.4.44** (`v1.4.44`, Android version code 56).

Version 1.4.44 keeps the local multilingual translation safeguards and repairs caption-script editing: the list drives timeline time only while the user scrolls it, transport playback cannot steal that gesture, and the lower-half editor remains bounded below the preview while typing. The active or focused caption stays visible, so video playback and the caption being edited remain available together.
...
The installer requires release 1.4.44 or newer and refuses older APKs while the release is building. Both download routes use Hatsunama/Caption-Studio. See [audit coverage](docs/audit-1.4.8.md).
